...
${this.EMOJIS.link} ruralinsights.com.br`;
  ...
  /**
   * Gera PDF avançado com gráficos
   */
  ...
  private static async addChartsPage(pdf: jsPDF, analysis: any, scoreData: any) {
    let yPos = 30;
    // const pageWidth = pdf.internal.pageSize.getWidth(); // removido pois não está sendo usado
  ...
  private static async addDetailedAnalysis(pdf: jsPDF, analysis: any, _scoreData: any) {
    let yPos = 30;
    const pageWidth = pdf.internal.pageSize.getWidth(); // usado para desenhar linhas
